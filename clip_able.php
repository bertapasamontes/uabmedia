...
<!-- End Google Tag Manager -->
		...
		<!-- Dependencies AblePlayer-->
		<script src="//ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
		<script src="//cdn.jsdelivr.net/npm/js-cookie@3.0.1/dist/js.cookie.min.js"></script>

		<!-- CSS -->
		<link rel="stylesheet" href="https://uab.media/assets/ableplayer/build/ableplayer.min.css" type="text/css"/>

		<!-- JavaScript -->
		<script src="https://uab.media/assets/ableplayer/build/ableplayer.min.js"></script>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-8">
					<div id="reproductor">
						<video id="video1" data-able-player preload="auto" width="100%" poster="<?php echo $data->data->img_poster; ?>">
							<source type="video/mp4" src="<?php echo $data->media['0']->vod_html5_h264; ?>" data-desc-src="path_to_described_video.mp4"/>
						</video>
					</div>
					<br/>
				</div>
				<div class="col-12 col-md-4">
					...
					?>
					<div class="um-capcalera d-flex align-items-center" style="margin-top:30px!important;margin-bottom:40px!important">
