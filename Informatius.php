						...
						<div class="col-12 overflow-hidden">
							<div class="um-capcalera d-flex align-items-center">
								<div class="icono-capcelera">
									...
									<h1 class="main-title titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Informatius. UABmèdia</h1>
								</div>
				  ...
				  <nav>
					  <ul class="d-flex align-items-center list-inline m-0">
						  <li class="nav-item nav-icon" style="margin-right: 10px!important;">
							 <div class="informatius_selec"> <a href="Informatius">Informatius
								 </a></div>
						  </li>
						  <li class="nav-item nav-icon" style="margin-right: 10px!important;">
