...
<!-- End Google Tag Manager (noscript) -->
						...
						<div class="col-12 overflow-hidden">
							<div class="um-capcalera d-flex align-items-center">
								<div class="icono-capcelera">
									...
									<h1 class="main-title titol-capcelera" style="font-size: 2.369em;line-height: 0.8!important">Notícies de Política. UABmèdia</h1>
								</div>
			  ...
			  <div class="row">
				  ...
				  <nav>
					  <ul class="d-flex align-items-center list-inline m-0">
						  ...
						  <li class="nav-item nav-icon" style="margin-right: 10px!important;">
							  <div class="politica_selec"><a href="Noticies_Política">Política
								  </a></div>
						  </li>
						  <li class="nav-item nav-icon" style="margin-right: 10px!important;">
 ...
 <section id="politica" style="background-color: #5d5c5c;padding-top:40px;padding-bottom:20px">
 <?php
 include 'config.php';
